...
import { X, Clock, Zap, AlertCircle, Calendar, PiggyBank } from 'lucide-react';
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ background: colorMap[appliance.color] || colorMap['bg-blue-500'] }}
        >
          {/* Close button */}
          <button
            onClick={onClose}
        ...
        <div className="p-5 space-y-5">
          ...
          <div>
            ...
            <div className="flex gap-3 mb-3">
              ...
              >
                ...
                <div>
                  <span className="text-[10px] block" style={{ color: theme.textMuted }}>Dur&eacute;e</span>
              ...
              >
                ...
                <div>
                  <span className="text-[10px] block" style={{ color: theme.textMuted }}>Fr&eacute;quence</span>
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div>
                <span className="text-xs font-bold block mb-1" style={{ color: theme.textPrimary }}>&Eacute;conomies</span>
