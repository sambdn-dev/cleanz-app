...
export const INGREDIENTS: Ingredient[] = [
  ...
  { id: 2, nom: 'Vinaigre blanc', emoji: '🧴', fonctions: ['Détartrant', 'Nettoyant', 'Anti-calcaire'], essentiel: true, prix: '0.50€/L', description: 'Le vinaigre blanc est le champion anti-calcaire.' },
  ...
  { id: 5, nom: 'Percarbonate', emoji: '✨', fonctions: ['Blanchissant', 'Détachant', 'Désodorisant'], essentiel: true, prix: '4-6€/kg', description: "Le percarbonate de soude est l'eau oxygénée en poudre." },
  ...
  { id: 9, nom: 'Alcool ménager', emoji: '🔬', fonctions: ['Nettoyant', 'Vitres', 'Anti-traces'], essentiel: true, prix: '3-5€/L', description: "L'alcool ménager nettoie et s'évapore sans traces." },
